...
<?php        
   include('php/views/arañas_vasculares.html');
?>
<button class="btn btn-success whatsapp-btn border"><i class="fa-brands fa-whatsapp mx-2" style="color: #ffffff;"></i><a href="https://wa.me/34699199084" class="text-white">Contáctanos</a></button>
    </main>
<?php    
