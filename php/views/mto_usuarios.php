              ...
              <div class="contact-form">
                  <div class="header">
                      ...
                      <h2 class="text-center">Consulta de usuarios</h2>
                          ...
                          <div>
                            <button class='btn btn-danger col-4 align-middle mx-1 my-3 ' type="button"><i class="fa-regular fa-trash-can mx-2" style="color: #ffffff;"></i>Eliminar Usuario</button>
                            <?php
